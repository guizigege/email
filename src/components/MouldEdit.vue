    ...
    <div style="padding:20px 20px 0 20px;">
      ...
      <div style="height:20px;line-height: 20px;padding-left: 20px;">
        <el-breadcrumb separator-class="el-icon-arrow-right" >
          ...
          <el-breadcrumb-item :to="{ path: '/home/mould/edit' }">编辑模板</el-breadcrumb-item>
      ...
      <div class="setParamDialog" style="padding:20px 0;box-sizing: border-box">
        ...
        <div style="border:1px solid steelblue;padding:12px 20px 20px 20px">
            ...
            <el-table
              ...
              <el-table-column label="设置值"  width="290">
                <template slot-scope="scope">
                  ...
                  <el-checkbox-group v-model="nameSeperateWay" v-if="(scope.$index)===3?true:false" :disabled="!(params.sendertype===2)" @change="seperateWay">
                    <el-checkbox :label=1  class="email-task" :disabled="!(params.sendertype===2)">平均分配</el-checkbox>
                    <el-checkbox :label=2  class="email-task" :disabled="!(params.sendertype===2)">全部分配</el-checkbox>
                  </el-checkbox-group>
          ...
          <div style="margin-top: 10px;padding-left:150px;padding-top:10px;border-top:1px solid #ddd">
            <el-button @click="doEdit" type="primary" plain style="margin-right: 80px;">确定</el-button>
...
<script>
  export default {
    ...
    methods: {
      // 读取模板信息
      get_template_info(){
        this.$get('/template/info',{id:parseInt(this.$route.params.id)})
          .then((res)=>{
            this.params = res.data;
            if(this.params.sendertype===0||this.params.sendertype===1){
              this.senderType0.push(this.params.sendertype)
            }else{
              this.senderType1.push(this.params.sendertype)
            }
            this.nameSeperateWay.push(this.params.name_seperate_way)
          })
      },
      // 修改模板
      modify_template(){
